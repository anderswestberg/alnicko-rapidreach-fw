/**
 * @file cs43l22.c
 * @brief CS43L22 audio codec driver
 *
 * This driver was added from a newer version of Zephyr to enable audio functionality
 * on the STM32F4 Discovery board. It was added specifically to:
 * - Check a working I2S + codec API on the STM32F4 Discovery
 * - Enable testing and debugging of the audio player module
 *
 * @note This implementation is intended for evaluation and development purposes.
 * 
 * @author Eugene K.
...
static inline int cs43l22_write_masked(const struct i2c_dt_spec *i2c,
                                       uint8_t                   reg,
                                       uint8_t                   value,
                                       uint8_t                   mask)
{
